...
**It went out and came back.** Built, then reverted a few hours later while
people were testing the preview — not because anything was wrong with it, but
because it was the wrong moment to change the app under them — then restored
once testing was done. The round trip is in the history (12b901a, its revert,
and the revert of that). Nothing about the feature changed in between, which
is the point: a revert is a cheap way to hold a finished thing back, as long
as what it is holding back is written down.
